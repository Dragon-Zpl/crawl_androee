...
a = """
package: name='com.outerminds.tubular' versionCode='120' versionName='1.36.0' platformBuildVersionName='6.0-2438415'
install-location:'preferExternal'
sdkVersion:'16'
targetSdkVersion:'27'
application-label:'PewDiePie: Tuber Simulator'
application-label-ca:'PewDiePie: Tuber Simulator'
application-label-da:'PewDiePie: Tuber Simulator'
application-label-fa:'PewDiePie: Tuber Simulator'
"""
pkgname = re.search(r'package: name=\'(.*?)\'', a)
print(pkgname.group(1))